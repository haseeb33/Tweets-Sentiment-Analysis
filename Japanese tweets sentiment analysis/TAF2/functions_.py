...
def H_I_J_values_X_150_users(df, H_I_J_cols):
    H = df[df['tweet_count'] >= 50][H_I_J_cols[0]].values.tolist()
    I = df[df['tweet_count'] >= 50][H_I_J_cols[1]].values.tolist()
    J = df[df['tweet_count'] >= 50][H_I_J_cols[2]].values.tolist()
    return H, I, J
...
def negative_tweet_porpostion_X(df, H_I_J_cols):
    X = df[df['r_neg_tweets'].notna()]['r_neg_tweets'].values.tolist()
    X = [[i] for i in X]
    H = df[df['r_neg_tweets'].notna()][H_I_J_cols[0]].values.tolist()
    I = df[df['r_neg_tweets'].notna()][H_I_J_cols[1]].values.tolist()
    J = df[df['r_neg_tweets'].notna()][H_I_J_cols[2]].values.tolist()
    return X, H, I, J

def negative_tweet_porpostion_X_150_users(df, H_I_J_cols):
    X = df[df['tweet_count'] >= 50]['r_neg_tweets'].values.tolist()
    X = [[i] for i in X]
    H, I, J = H_I_J_values_X_150_users(df, H_I_J_cols)
    return X, H, I, J

def negative_tweet_count_X_150_users(df, H_I_J_cols):
    X = df[df['tweet_count'] >= 50]['n_neg_tweets'].values.tolist()
    X = [[i] for i in X]
    H, I, J = H_I_J_values_X_150_users(df, H_I_J_cols)
    return X, H, I, J

def negative_tweet_count_X(df, H_I_J_cols):
    X = df[df['n_neg_tweets'].notna()]['n_neg_tweets'].values.tolist()
    X = [[i] for i in X]
    H = df[df['r_neg_tweets'].notna()][H_I_J_cols[0]].values.tolist()
    I = df[df['r_neg_tweets'].notna()][H_I_J_cols[1]].values.tolist()
    J = df[df['r_neg_tweets'].notna()][H_I_J_cols[2]].values.tolist()
...
def positive_tweet_porpostion_X(df, H_I_J_cols):
    X = df[df['r_pos_tweets'].notna()]['r_pos_tweets'].values.tolist()
    X = [[i] for i in X]
    H = df[df['r_pos_tweets'].notna()][H_I_J_cols[0]].values.tolist()
    I = df[df['r_pos_tweets'].notna()][H_I_J_cols[1]].values.tolist()
    J = df[df['r_pos_tweets'].notna()][H_I_J_cols[2]].values.tolist()
    return X, H, I, J

def positive_tweet_porpostion_X_150_users(df, H_I_J_cols):
    X = df[df['tweet_count'] >= 50]['r_pos_tweets'].values.tolist()
    X = [[i] for i in X]
    H, I, J = H_I_J_values_X_150_users(df, H_I_J_cols)
    return X, H, I, J

def positive_tweet_count_X(df, H_I_J_cols):
    X = df[df['n_pos_tweets'].notna()]['n_pos_tweets'].values.tolist()
    X = [[i] for i in X]
    H = df[df['n_pos_tweets'].notna()][H_I_J_cols[0]].values.tolist()
    I = df[df['n_pos_tweets'].notna()][H_I_J_cols[1]].values.tolist()
    J = df[df['n_pos_tweets'].notna()][H_I_J_cols[2]].values.tolist()
    return X, H, I, J

def positive_tweet_count_X_150_users(df, H_I_J_cols):
    X = df[df['tweet_count'] >= 50]['n_pos_tweets'].values.tolist()
    X = [[i] for i in X]
    H, I, J = H_I_J_values_X_150_users(df, H_I_J_cols)
    return X, H, I, J

def tweet_count_X_150_users(df, H_I_J_cols):
...
def gender_X_150_users(df, H_I_J_cols):
    X = df[df['tweet_count'] >= 50]['Gender'].values.tolist()
    X = [[i] for i in X]
    H, I, J = H_I_J_values_X_150_users(df, H_I_J_cols)
    return X, H, I, J
...
def topic_proportion_X_150_users(df, df_topics, H_I_J_cols):
    X = df_topics.drop(columns=['index','通し番号']).values.tolist()
    H, I, J = H_I_J_values_X_150_users(df, H_I_J_cols)
    return X, H, I, J

def positive_negative_tweet_topic_proportion_X_150_users(df, df_topics, H_I_J_cols):
    new_df = df_topics.copy()
    new_df['r_pos_tweets'] = df.loc[df['tweet_count']>= 50]['r_pos_tweets'].values.tolist()
    new_df['r_neg_tweets'] = df.loc[df['tweet_count']>= 50]['r_neg_tweets'].values.tolist()
