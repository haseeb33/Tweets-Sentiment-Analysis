...
df_neural_net = pd.read_excel("neural_net_senti/result_new_sentiment_analysis.xlsx")
...
X, H, I, J = functions_.negative_tweet_porpostion_by_neural_net_X_65_users(df_neural_net)

#X, H, I, J = functions_.positive_tweet_porpostion_by_neural_net_X_65_users(df_neural_net)

#X, H, I, J = functions_.positive_negative_tweet_by_neural_net_X_65_users(df_neural_net)
...
#X, H, I, J = functions_.gender_X_65_users(df)

#X, H, I, J = functions_.followers_X(df)
#X, H, I, J = functions_.followers_X_65_users(df)

#X, H, I, J = functions_.following_X(df)
#X, H, I, J = functions_.following_X_65_users(df)

#X, H, I, J = functions_.followers_following_X(df)
#X, H, I, J = functions_.followers_following_X_65_users(df)

#X, H, I, J = functions_.all_numerical_params_X(df)
#X, H, I, J = functions_.all_numerical_params_X_65_users(df)

#X, H, I, J = functions_.topic_proportion_X_65_users(df, df_topics)

#X, H, I, J = functions_.positive_negative_tweet_topic_proportion_X_65_users(df_neural_net, df_topics)
